...
export class CommunityService {
     ...
     */
    async shareDocToCommunity(workspaceId, docId, data) {
     ...
     */
    async getCommunityDocs(workspaceId, params = {}) {
     ...
     * @returns Promise<CommunityApiResponse>
     */
    async unshareDocFromCommunity(workspaceId, docId) {
     ...
     * @returns Promise<CommunityApiResponse>
     */
    async updateCommunityPermission(workspaceId, docId, permission) {
     ...
     * @returns Promise<CommunityApiResponse>
     */
    async incrementViewCount(workspaceId, docId) {
     ...
     */
    async getCommunityDocStatus(workspaceId, docId) {
...
export const communityApi = {
     ...
     * 分享文档到社区
     */
    shareDocToCommunity: (workspaceId, docId, data) => communityService.shareDocToCommunity(workspaceId, docId, data),
    /**
     * 获取社区文档列表
     */
    getCommunityDocs: (workspaceId, params) => communityService.getCommunityDocs(workspaceId, params),
    /**
     * 取消文档社区分享
     */
    unshareDocFromCommunity: (workspaceId, docId) => communityService.unshareDocFromCommunity(workspaceId, docId),
    /**
     * 更新文档社区权限
     */
    updateCommunityPermission: (workspaceId, docId, permission) => communityService.updateCommunityPermission(workspaceId, docId, permission),
    /**
     * 增加文档浏览次数
     */
    incrementViewCount: (workspaceId, docId) => communityService.incrementViewCount(workspaceId, docId),
    /**
     * 获取文档社区分享状态
     */
    getCommunityDocStatus: (workspaceId, docId) => communityService.getCommunityDocStatus(workspaceId, docId)
};
/**
 * 权限选项配置（供UI组件使用）
 */
