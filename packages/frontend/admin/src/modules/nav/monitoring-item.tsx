...
// 监控与运维相关的配置组
const MONITORING_CONFIG_GROUPS = [
  {
    name: '任务管理',
    module: 'job',
  },
...
export const MonitoringItem = ({ isCollapsed }: { isCollapsed: boolean }) => {
        ...
        <NavigationMenuPrimitive.List>
          <NavigationMenuPrimitive.Item>
            ...
            <NavigationMenuPrimitive.Content>
              ...
              >
                {MONITORING_CONFIG_GROUPS.map(group => (
      ...
      >
        ...
        >
          <div className="flex items-center">
            ...
            <span className="font-medium">监控与运维</span>
          </div>
        </AccordionTrigger>
