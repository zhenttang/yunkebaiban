...
const WorkspaceYunkePropertiesSchemaSchema = z.object({
...
export const WorkspaceYunkePropertiesSchema = z.object({
  schema: WorkspaceYunkePropertiesSchemaSchema.optional(),
...
export type WorkspaceYunkeProperties = z.infer<
  typeof WorkspaceYunkePropertiesSchema
>;
...
export type WorkspaceYunkePageProperties = z.infer<
