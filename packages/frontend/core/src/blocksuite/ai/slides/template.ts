    ...
    images: await getImages(
      {
        ...
        background: () =>
          'https://cdn.yunke.pro/ppt-images/background/basic_2_selection_background.png',
      },
      template
    ),
    content: template,
    ...
    images: await getImages(
      {
        ...
        background: () =>
          'https://cdn.yunke.pro/ppt-images/background/basic_3_selection_background.png',
      },
      template
    ),
    content: template,
    ...
    images: await getImages(
      {
        ...
        background: () =>
          'https://cdn.yunke.pro/ppt-images/background/basic_4_selection_background.png',
      },
      template
    ),
    content: template,
