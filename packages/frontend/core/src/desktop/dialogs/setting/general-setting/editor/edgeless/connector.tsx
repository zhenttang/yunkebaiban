...
export const ConnectorSettings = () => {
    ...
    () => [
      {
        ...
        label:
          t[
            'com.yunke.settings.editorSettings.edgeless.connecter.connector-shape.elbowed'
          ](),
      },
      {
        ...
        label:
          t[
            'com.yunke.settings.editorSettings.edgeless.connecter.connector-shape.curve'
          ](),
      },
      {
        ...
        label:
          t[
            'com.yunke.settings.editorSettings.edgeless.connecter.connector-shape.straight'
          ](),
      },
    ],
    [t]
  ...
  return (
    <>
      <EdgelessSnapshot
        title={t['com.yunke.settings.editorSettings.edgeless.connecter']()}
        docName="connector"
        keyName="connector"
      ...
      <SettingRow
        name={t[
          'com.yunke.settings.editorSettings.edgeless.connecter.color'
        ]()}
        desc={''}
      >
        {currentColor ? (
      ...
      <SettingRow
        name={t[
          'com.yunke.settings.editorSettings.edgeless.connecter.connector-shape'
        ]()}
        desc={''}
      >
        <RadioGroup
      ...
      <SettingRow
        name={t[
          'com.yunke.settings.editorSettings.edgeless.connecter.border-style'
        ]()}
        desc={''}
      >
        <RadioGroup
      ...
      <SettingRow
        name={t[
          'com.yunke.settings.editorSettings.edgeless.connecter.border-thickness'
        ]()}
        desc={''}
      >
        <Slider
      ...
      <SettingRow
        name={t[
          'com.yunke.settings.editorSettings.edgeless.connecter.start-endpoint'
        ]()}
        desc={''}
      >
        <DropdownMenu
      ...
      <SettingRow
        name={t[
          'com.yunke.settings.editorSettings.edgeless.connecter.end-endpoint'
        ]()}
        desc={''}
      >
        <DropdownMenu
