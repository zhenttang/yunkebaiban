...
export function App() {
    return (_jsx(Suspense, { children: _jsx(FrameworkRoot, { framework: frameworkProvider, children: _jsx(CacheProvider, { value: cache, children: _jsx(I18nProvider, { children: _jsx(YunkeContext, { store: getCurrentStore(), children: _jsxs(CloudStorageProvider, { children: [_jsx(DesktopThemeSync, {}), _jsx(RouterProvider, { fallbackElement: _jsx(AppContainer, { fallback: true }), router: router, future: future }), environment.isWindows && (_jsx("div", { style: { position: 'fixed', right: 0, top: 0, zIndex: 5 }, children: _jsx(WindowsAppControls, {}) }))] }) }) }) }) }) }));
}
