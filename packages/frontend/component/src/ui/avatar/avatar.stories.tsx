...
DefaultAvatar.args = {
  name: 'YUNKE',
  url: 'https://yunke.pro/favicon-96.png',
  size: 50,
};
...
export const ColorfulFallbackWithDifferentSize: StoryFn<AvatarProps> = args => (
  <>
    <Avatar {...args} size={20} colorfulFallback name="YUNKE" />
    <Avatar {...args} size={40} colorfulFallback name="YUNKE" />
    <Avatar {...args} size={60} colorfulFallback name="YUNKE" />
  </>
);
...
WithRemove.args = {
  ...
  name: 'With Hover',
  hoverIcon: <CameraIcon />,
  removeTooltipOptions: { content: '这是删除工具提示' },
  avatarTooltipOptions: { content: '这是头像工具提示' },
  onRemove: e => {
...
export const CustomizeBorderRadius: StoryFn<AvatarProps> = args => (
  <div style={{ display: 'flex', gap: 4 }}>
    <Avatar {...args} size={60} colorfulFallback name="YUNKE" rounded={10} />
