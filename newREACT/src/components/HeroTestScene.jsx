...
const HeroTestScene = () => {
  ...
  useEffect(() => {
    ...
    gsap.from(heroGroup.position, { y: -10, duration: 2.5, ease: 'power3.out' });
    ...
    const handleResize = () => {
      ...
      if (width < 768) {
        ...
        rulerGroup.position.set(0, -2, -2);
        eraserGroup.position.set(1.5, -4, 1);
        tagGroup.position.set(1.5, 4, -2);
  ...
  return (
    <div className="hero-shell hero-shell-test">
