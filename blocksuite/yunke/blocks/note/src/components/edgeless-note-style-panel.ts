...
import type { LineDetailType } from '@blocksuite/yunke-components/edgeless-line-styles-panel';
import type { SliderSelectEvent } from '@blocksuite/yunke-components/slider';
import {
  DefaultTheme,
  NoteBlockModel,
  type NoteProps,
  ...
  private _renderStylePanel() {
    return html`<div class="edgeless-note-style-panel">
      <div class="edgeless-note-style-section">
        <div class="edgeless-note-style-section-title">填充颜色</div>
      ...
      <div class="edgeless-note-style-section">
        <div class="edgeless-note-style-section-title">阴影</div>
  ...
  override render() {
    return html`
      <editor-menu-button
        .contentPadding=${'8px'}
        .button=${html`
          <editor-icon-button aria-label="便签样式" .tooltip=${'便签样式'}>
            ${PaletteIcon()}
          </editor-icon-button>
        `}
