...
import { createdByPropertyModelConfig } from './define.js';
...
export class CreatedByCell extends BaseCellRenderer<UserValue, UserValue> {
  ...
  override connectedCallback(): void {
    ...
    this.classList.add(createdByCellStyle);
  }
...
export const createdByColumnConfig =
  createdByPropertyModelConfig.createPropertyMeta({
    icon: createIcon('SinglePersonIcon'),
    cellRenderer: {
      view: createFromBaseCellRenderer(CreatedByCell),
    },
  });
