import { ListBlockSchema } from '@blocksuite/yunke-model';
import {
  AdapterTextUtils,
...
export const listBlockHtmlAdapterMatcher: BlockHtmlAdapterMatcher = {
  ...
  fromBlockSnapshot: {
    enter: (o, context) => {
      ...
      if (
        walkerContext.getNodeContext('yunke:list:parent') === o.parent &&
        ...
        walkerContext.setNodeContext('yunke:list:parent', o.parent);
      }
    ...
    leave: (o, context) => {
      ...
      if (
        walkerContext.getPreviousNodeContext('yunke:list:parent') ===
          o.parent &&
