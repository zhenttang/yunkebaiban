import { ImageBlockModel } from '@blocksuite/yunke-model';
import {
  ActionPlacement,
...
import { openDeckerEditor, openDeckerEditorWithData } from '@yunke/core/modules/decker-integration/decker-integration-manager';
      ...
      actions: [
        {
          ...
          when(ctx) {
            const supported =
              ctx.store.schema.flavourSchemaMap.has('yunke:attachment');
