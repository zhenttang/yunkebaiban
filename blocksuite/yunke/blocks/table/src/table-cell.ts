...
import { TextBackgroundDuotoneIcon } from '@blocksuite/yunke-components/icons';
import { DefaultInlineManagerExtension } from '@blocksuite/yunke-inline-preset';
import type { TableColumn, TableRow } from '@blocksuite/yunke-model';
import { RichText } from '@blocksuite/yunke-rich-text';
import { cssVarV2 } from '@blocksuite/yunke-shared/theme';
import { getViewportElement } from '@blocksuite/yunke-shared/utils';
...
export const TableCellComponentName = 'yunke-table-cell';
export class TableCell extends SignalWatcher(
  ...
  get inlineManager() {
    return this.closest<TableBlockComponent>('yunke-table')?.std.get(
      DefaultInlineManagerExtension.identifier
    );
  }

  get topContenteditableElement() {
    return this.closest<TableBlockComponent>('yunke-table')
        ...
        <rich-text
          ...
          .verticalScrollContainerGetter="${() =>
            this.topContenteditableElement?.host
              ...
              : null}"
          data-parent-flavour="yunke:table"
        ></rich-text>
