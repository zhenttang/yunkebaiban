 ...
 *     Example: `shapeDomRenderer` in `blocksuite/yunke/gfx/shape/src/element-renderer/shape-dom/index.ts`.
 ...
 *     Import `DomElementRendererExtension` (e.g., from `@blocksuite/yunke-block-surface` or its source location
 *     `blocksuite/yunke/blocks/surface/src/extensions/dom-element-renderer.ts`).
 ...
 *     Example: `ShapeDomRendererExtension` in `blocksuite/yunke/gfx/shape/src/element-renderer/shape-dom.ts`.
 *
 ...
 *     As seen with `ShapeDomRendererExtension` being registered in `blocksuite/yunke/gfx/shape/src/view.ts`.
 *
 ...
 *         `blocksuite/yunke/blocks/surface/src/renderer/dom-elements/index.ts`.
 ...
 *         (e.g., from `@blocksuite/yunke-block-surface` or its source).
 ...
 *
 * 5.  **Ensure Exports**:
 *     -   The `DomRenderer` class itself should be accessible (e.g., exported from `@blocksuite/yunke/blocks/surface`).
