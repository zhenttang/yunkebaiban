import { ListBlockModel, ParagraphBlockModel } from '@blocksuite/yunke-model';
import type { IndentContext } from '@blocksuite/yunke-shared/types';
import {
...
export const indentParagraphCommand: Command<{
  ...
  if (
    ...
    indentContext.flavour !== 'yunke:paragraph'
  ) {
    console.warn(
