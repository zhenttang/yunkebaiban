import type { CanvasElementWithText } from '@blocksuite/yunke-block-surface';
import type { PanTool } from '@blocksuite/yunke-gfx-pointer';
import {
...
import { isTopLevelBlock } from '@blocksuite/yunke-shared/utils';
import type {
  GfxModel,
...
export function isEdgelessTextBlock(
  ...
  return (
    !!element &&
    'flavour' in element &&
    element.flavour === 'yunke:edgeless-text'
  );
}
...
export function isImageBlock(
  ...
  return (
    !!element && 'flavour' in element && element.flavour === 'yunke:image'
  );
}
...
export function isAttachmentBlock(
  ...
  return (
    !!element && 'flavour' in element && element.flavour === 'yunke:attachment'
  );
}
...
export function isEmbedSyncedDocBlock(
  ...
  return (
    !!element &&
    'flavour' in element &&
    element.flavour === 'yunke:embed-synced-doc'
  );
}
