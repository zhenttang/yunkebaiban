import { NoteConfigExtension } from '@blocksuite/yunke-block-note';
import {
  DefaultTool,
  getBgGridGap,
...
import { isSingleMindMapNode } from '@blocksuite/yunke-gfx-mindmap';
import { PanTool } from '@blocksuite/yunke-gfx-pointer';
import { mountShapeTextEditor } from '@blocksuite/yunke-gfx-shape';
import {
  NoteBlockModel,
  type RootBlockModel,
...
> {
  ...
  get surfaceBlockModel() {
    return this.model.children.find(
      child => child.flavour === 'yunke:surface'
