import { isFrameBlock } from '@blocksuite/yunke-block-frame';
import { getSurfaceBlock, isNoteBlock } from '@blocksuite/yunke-block-surface';
import {
...
export function createLinkedDocFromEdgelessElements(
  ...
  linkedDoc.load(() => {
    ...
    const surfaceId = linkedDoc.addBlock('yunke:surface', {}, rootId);
