...
import type { FrameBlockProps } from '@blocksuite/yunke-model';
import { encodeClipboardBlobs } from '@blocksuite/yunke-shared/adapters';
...
export function createNewPresentationIndexes(
  ...
  const frames = raw
    .filter((block): block is FrameSnapshot => {
      ...
      return data?.flavour === 'yunke:frame';
    })
