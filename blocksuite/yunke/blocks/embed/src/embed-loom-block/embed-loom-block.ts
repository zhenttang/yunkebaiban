import { LoadingIcon, OpenIcon } from '@blocksuite/yunke-components/icons';
import type { EmbedLoomModel, EmbedLoomStyles } from '@blocksuite/yunke-model';
...
> {
  ...
  override renderBlock() {
    ...
    const titleText = loading ? '加载中...' : title;
