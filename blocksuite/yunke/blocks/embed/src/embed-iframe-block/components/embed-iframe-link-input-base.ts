import type { EmbedIframeBlockModel } from '@blocksuite/yunke-model';
import {
  EmbedIframeService,
  NotificationProvider,
} from '@blocksuite/yunke-shared/services';
import { isValidUrl, stopPropagation } from '@blocksuite/yunke-shared/utils';
...
export class EmbedIframeLinkInputBase extends WithDisposable(LitElement) {
  ...
  protected async onConfirm() {
    ...
    try {
      ...
      if (!canEmbed) {
        console.log('iframe 无法嵌入，添加为书签', url);
