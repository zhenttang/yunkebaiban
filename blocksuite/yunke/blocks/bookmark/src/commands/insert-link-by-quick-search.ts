import { insertEmbedIframeWithUrlCommand } from '@blocksuite/yunke-block-embed';
import {
  type InsertedLinkType,
  insertEmbedLinkedDocCommand,
  insertEmbedSyncedDocCommand,
  type LinkableFlavour,
} from '@blocksuite/yunke-block-embed-doc';
import {
  DocModeProvider,
  ...
  const insertedLinkType: Promise<InsertedLinkType> = quickSearchService
    ...
    .then(result => {
      ...
      if ('docId' in result) {
        ...
        let flavour: LinkableFlavour = 'yunke:embed-linked-doc';
