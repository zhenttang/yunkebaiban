...
export const YUNKE_FRAME_PANEL_HEADER = 'yunke-frame-panel-header';
  ...
  override render() {
    return html`<div class="frame-panel-header">
      <div class="all-frames-setting">
        <span class="all-frames-setting-label">所有框架</span>
        <edgeless-tool-icon-button
          class="all-frames-setting-button ${this._settingPopperShow
            ? 'active'
            : ''}"
          .tooltip=${this._settingPopperShow ? '' : '所有框架设置'}
          .tipPosition=${'top'}
...
declare global {
  interface HTMLElementTagNameMap {
    [YUNKE_FRAME_PANEL_HEADER]: FramePanelHeader;
  }
}
