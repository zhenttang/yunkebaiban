...
const styles = css`
  ...
  yunke-database-virtual-column-stats:hover .stats-cell {
    opacity: 1;
  }

  .stats-cell:hover,
  yunke-database-virtual-column-stats-cell.active .stats-cell {
    opacity: 1;
...
declare global {
  interface HTMLElementTagNameMap {
    'yunke-database-virtual-column-stats-cell': VirtualDatabaseColumnStatsCell;
  }
}
