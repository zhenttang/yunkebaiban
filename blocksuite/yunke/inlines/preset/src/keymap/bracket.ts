import { insertLinkedNode } from '@blocksuite/yunke-inline-reference';
import { CodeBlockModel } from '@blocksuite/yunke-model';
import { getInlineEditorByModel } from '@blocksuite/yunke-rich-text';
import { BRACKET_PAIRS } from '@blocksuite/yunke-shared/consts';
