...
import { EdgelessDraggableElementController } from '@blocksuite/yunke-widget-edgeless-toolbar';
...
export class EdgelessTemplatePanel extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .search-bar {
      padding: 21px 24px;
      font-size: 18px;
      color: var(--yunke-secondary);
      border-bottom: 1px solid var(--yunke-divider-color);
    ...
    .template-item > svg {
      ...
      width: 135px;
      height: 80px;
      color: var(--yunke-background-primary-color);
    }
    ...
    .template-item.loading > yunke-template-loading {
      position: absolute;
      left: 50%;
      top: 50%;
      transform: translate(-50%, -50%);
    ...
    .arrow {
      ...
      color: var(--yunke-background-overlay-panel-color);
    }
  `;
        ...
        <div class="template-viewport">
          <div class="template-scrollcontent" data-scrollable>
            <div class="template-list">
              ${this._loading
                ? html`<yunke-template-loading
                    style=${styleMap({
                      position: 'absolute',
                      left: '50%',
                      top: '50%',
                    })}
                  ></yunke-template-loading>`
                : repeat(
                    _templates,
                      ...
                      return html`
                        ...
                        >
                          ...
                          ${template === this._loadingTemplate
                            ? html`<yunke-template-loading></yunke-template-loading>`
                            : nothing}
                          ${template.name
                            ? html`<yunke-tooltip
                                .offset=${12}
