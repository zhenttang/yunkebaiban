...
import { DefaultTheme, TextElementModel } from '@blocksuite/yunke-model';
import type { RichText } from '@blocksuite/yunke-rich-text';
import { ThemeProvider } from '@blocksuite/yunke-shared/services';
import { getSelectedRect } from '@blocksuite/yunke-shared/utils';
...
export class EdgelessTextEditor extends WithDisposable(ShadowlessElement) {
  ...
  static PLACEHOLDER_TEXT = '从这里开始输入';
