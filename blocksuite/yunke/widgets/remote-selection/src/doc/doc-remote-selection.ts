...
import { getSelectionRectsCommand } from '@blocksuite/yunke-shared/commands';
import { EMBED_BLOCK_MODEL_LIST } from '@blocksuite/yunke-shared/consts';
...
export class YunkeDocRemoteSelectionWidget extends WidgetComponent {
  ...
  private _getCursorRect(selections: BaseSelection[]): SelectionRect | null {
    ...
    if (this.block.model.flavour !== 'yunke:page') {
