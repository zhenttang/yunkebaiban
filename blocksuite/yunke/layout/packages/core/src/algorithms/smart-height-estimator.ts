...
export class SmartBlockHeightEstimator implements BlockHeightEstimator {
  ...
  private _estimateCalloutHeight(block: Block, metrics: BlockTypeMetrics): number {
    ...
    const textHeight = this._estimateParagraphHeight(block, this.typeMetrics.get('yunke:paragraph')!);
  ...
  private _initializeTypeMetrics(): void {
    const defaultMetrics: Record<string, BlockTypeMetrics> = {
      'yunke:paragraph': { baseHeight: 60, minHeight: 30, maxHeight: 500, avgAccuracy: 0.8, sampleCount: 0 },
      'yunke:heading': { baseHeight: 80, minHeight: 40, maxHeight: 120, avgAccuracy: 0.9, sampleCount: 0 },
      'yunke:list': { baseHeight: 120, minHeight: 40, maxHeight: 800, avgAccuracy: 0.7, sampleCount: 0 },
      'yunke:code': { baseHeight: 150, minHeight: 60, maxHeight: 1000, avgAccuracy: 0.85, sampleCount: 0 },
      'yunke:image': { baseHeight: 250, minHeight: 100, maxHeight: 600, avgAccuracy: 0.9, sampleCount: 0 },
      'yunke:database': { baseHeight: 300, minHeight: 150, maxHeight: 800, avgAccuracy: 0.75, sampleCount: 0 },
      'yunke:callout': { baseHeight: 120, minHeight: 80, maxHeight: 300, avgAccuracy: 0.8, sampleCount: 0 }
    };
