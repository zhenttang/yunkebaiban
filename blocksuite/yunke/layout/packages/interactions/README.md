...
```typescript
import { createAnimationManager, AnimationConfig } from '@blocksuite/yunke-layout-interactions';
...
```typescript
import { ANIMATION_PRESETS, DURATION, EASING_FUNCTIONS } from '@blocksuite/yunke-layout-interactions';
...
// 系统会自动检测用户的减弱动画偏好
// 可以手动检查
import { AnimationUtils } from '@blocksuite/yunke-layout-interactions';
...
```typescript
import { PerformanceMonitor } from '@blocksuite/yunke-layout-interactions';
