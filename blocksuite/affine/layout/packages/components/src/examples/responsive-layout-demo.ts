...
export class ResponsiveLayoutDemo extends LitElement {
  ...
  private columnBlocks: Block[][] = [
    [
      { id: 'block-1', flavour: 'affine:paragraph', text: '这是第一个段落内容，展示响应式布局的基础功能。' },
      { id: 'block-2', flavour: 'affine:heading', text: '标题示例', props: { level: 2 } },
      { id: 'block-3', flavour: 'affine:code', text: 'console.log("响应式布局");' },
    ],
    [
      { id: 'block-4', flavour: 'affine:paragraph', text: '第二列的内容，会根据设备尺寸自动调整。' },
      { id: 'block-5', flavour: 'affine:image', text: '图片块', properties: { height: 200 } },
    ],
    [
      { id: 'block-6', flavour: 'affine:paragraph', text: '第三列内容，在移动端会自动折叠到单列显示。' },
    ],
    [],
    []
  ];
