...
```typescript
import { LayoutSwitcher } from '@blocksuite/affine-layout-components';
...
```typescript
import { ColumnContent } from '@blocksuite/affine-layout-components';
...
```typescript
import { ResponsiveLayoutDemo } from '@blocksuite/affine-layout-components';
...
```typescript
import { DesignTokens, StyleUtils } from '@blocksuite/affine-layout-components';
...
```typescript
// 自动连接Mock服务
import { MockPageLayoutService, MockColumnDistributor } from '@blocksuite/affine-layout-testing';
...
1. **安装依赖：**
```bash
npm install @blocksuite/affine-layout-components
npm install @blocksuite/affine-layout-interactions  # 响应式功能依赖
```

2. **导入响应式组件：**
```typescript
import '@blocksuite/affine-layout-components';
import { PageLayoutMode, ResponsiveChangeEvent } from '@blocksuite/affine-layout-components';
```
