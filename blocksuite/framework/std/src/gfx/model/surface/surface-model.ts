 ...
 * Used for text field
 */
export const SURFACE_TEXT_UNIQ_IDENTIFIER = 'yunke:surface:text';
/**
 * Used for field that use Y.Map. E.g. group children field
 */
export const SURFACE_YMAP_UNIQ_IDENTIFIER = 'yunke:surface:ymap';
