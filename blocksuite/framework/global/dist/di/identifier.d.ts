 ...
 */
export declare function createIdentifier<T>(name: string, variant?: ServiceVariant): ServiceIdentifier<T> & (<U extends T = T>(variant: ServiceVariant) => ServiceIdentifier<U>);
/**
 ...
 * @internal
 */
export declare function createIdentifierFromConstructor<T>(target: Type<T>): ServiceIdentifier<T>;
export declare function parseIdentifier(input: any): ServiceIdentifierValue;
