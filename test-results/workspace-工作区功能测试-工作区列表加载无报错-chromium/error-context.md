...
- Name: 工作区功能测试 >> 工作区列表加载无报错
- Location: D:\Documents\yunkebaiban\baibanfront\e2e\workspace.spec.ts:42:7
...
Expected: 0
Received: 4
    at D:\Documents\yunkebaiban\baibanfront\e2e\workspace.spec.ts:59:35
```
...
- navigation:
  ...
  - button:
    - img
  - link "全部文档":
    - /url: /workspace/np7Arn6jNSg2knFHIg8e2/all
    - img
    - text: 全部文档
  - link "日记":
    - /url: /workspace/np7Arn6jNSg2knFHIg8e2/journals
    - img
    - text: 日记
  - img
  - text: 设置
  ...
  - switch "其他":
    ...
    - img
  - link "回收站":
    - /url: /workspace/np7Arn6jNSg2knFHIg8e2/trash
    - img
    - text: 回收站
  - img
  - text: 导入
...
- link "文档":
  - /url: /workspace/np7Arn6jNSg2knFHIg8e2/all
- link "精选":
  - /url: /workspace/np7Arn6jNSg2knFHIg8e2/collection
- link "标签":
  - /url: /workspace/np7Arn6jNSg2knFHIg8e2/tag
- radiogroup:
  - radio:
    - img
  - radio:
...
- button "添加筛选条件"
- link "未命名 刚刚":
  - /url: /workspace/np7Arn6jNSg2knFHIg8e2/l9pjhkwfpd
  - listitem:
    - img
    - checkbox:
      - img
