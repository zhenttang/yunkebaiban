...
- Name: 工作区功能测试 >> 工作区切换无报错
- Location: D:\Documents\yunkebaiban\baibanfront\e2e\workspace.spec.ts:62:7
...
Expected: 0
Received: 4
    at D:\Documents\yunkebaiban\baibanfront\e2e\workspace.spec.ts:83:35
```
...
- navigation:
  ...
  - button:
    - img
  - link "全部文档":
    - /url: /workspace/07q20DeSLsOQNZp8lXMak/all
    - img
    - text: 全部文档
  - link "日记":
    - /url: /workspace/07q20DeSLsOQNZp8lXMak/journals
    - img
    - text: 日记
  - img
  - text: 设置
  ...
  - switch "其他":
    ...
    - img
  - link "回收站":
    - /url: /workspace/07q20DeSLsOQNZp8lXMak/trash
    - img
    - text: 回收站
  - img
  - text: 导入
...
- link "文档":
  - /url: /workspace/07q20DeSLsOQNZp8lXMak/all
- link "精选":
  - /url: /workspace/07q20DeSLsOQNZp8lXMak/collection
- link "标签":
  - /url: /workspace/07q20DeSLsOQNZp8lXMak/tag
- radiogroup:
  - radio:
    - img
  - radio:
...
- button "添加筛选条件"
- link "未命名 刚刚":
  - /url: /workspace/07q20DeSLsOQNZp8lXMak/ZELZCeL355
  - listitem:
    - img
    - checkbox:
      - img
